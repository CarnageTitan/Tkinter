...
header = Frame(root, width=700, height=200, bg="black")
header.grid(columnspan=3, rowspan=2, row=0)

#main content area - text and image extraction
main_content = Frame(root, width=700, height=200, bg="#F00E00")
...
def open_file():
    ...
    if file:
        ...
        img_menu = Frame(root, width=700, height=200)
        ...
        save_img_menu = Frame(root, width=700, height=200, bg="#c8c8c8")
...
#instructions
instructions = Label(root, text="Select a PDF file", font=("Raleway", 10), bg="black")
instructions.grid(column=2, row=0, sticky=SE, padx=75, pady=5)

#browse button
browse_text = StringVar()
browse_btn = Button(root, textvariable=browse_text, command=lambda:open_file(), font=("Raleway",12), bg="#F00E00", fg="black", height=1, width=15)
browse_text.set("Browse")
